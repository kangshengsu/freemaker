...
public class TreeUtil {
    ...
    public static boolean isNull4ParentCode(ITreeNode node) {
        return StringUtils.isBlank(node.getParentCode());
    }
     ...
     * @return 树的根节点
     */
    public static <T extends ITreeNode> TreeNode<T> buildCodeTree(List<T> values) {
        ...
        for (T value : values) {
            ...
            if (isNull4ParentCode(value)) {
                ...
                TreeNode<T> parentNode = nodeMap.get(value.getParentCode());
            ...
            nodeMap.put(value.getIncode(), node);
        ...
        if (!emptyValueList.isEmpty()) {
            ...
            for (T value : emptyValueList) {
                ...
                node = nodeMap.get(value.getIncode());
