...
CREATE TABLE `attachment_info` (
                                   ...
                                   PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18007 DEFAULT CHARSET=utf8 COMMENT='附件表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8003 DEFAULT CHARSET=utf8 COMMENT='需求表';
...
CREATE TABLE `display_config` (
                                  ...
                                  `ts` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '数据库时间戳',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8006 DEFAULT CHARSET=utf8 COMMENT='展位配置表';
...
CREATE TABLE `order_follow` (
                                ...
                                `ts` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '数据库时间戳',
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8013 DEFAULT CHARSET=utf8 COMMENT='订单流水';
...
CREATE TABLE `order_info` (
                              ...
                              PRIMARY KEY (`id`),
                              UNIQUE KEY `IDX_UN_CODE` (`code`) COMMENT '唯一索引'
) ENGINE=InnoDB AUTO_INCREMENT=8007 DEFAULT CHARSET=utf8 COMMENT='订单信息';
...
CREATE TABLE `order_operate_info` (
                                      ...
                                      `ts` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '数据库时间戳',
                                      PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4002 DEFAULT CHARSET=utf8mb4 COMMENT='岗位技能表';
...
) ENGINE=InnoDB AUTO_INCREMENT=20002 DEFAULT CHARSET=utf8 COMMENT='作品表';
...
) ENGINE=InnoDB AUTO_INCREMENT=8008 DEFAULT CHARSET=utf8 COMMENT='作品审核表';
